            ...
            <div className="grid gap-10 lg:grid-cols-2 items-center">
              <div className="space-y-4 text-start">
                ...
                <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Founded in 2010, Acme Fitness has been at the forefront of
                  helping people achieve their fitness goals. Our
                  state-of-the-art facilities, expert trainers, and supportive
                  community create the perfect environment for your fitness
                  journey.
                </p>
                <div className="flex flex-col gap-2 min-[400px] md:flex-row">
                  <button className="inline-flex items-center justify-center bg-black dark:bg-white text-white dark:text-black px-3 py-2 rounded-md">
                    Our Story
                  </button>
            ...
            <div className="grid gap-6 lg:grid-cols-3 lg:gap-12 mt-16">
              <div>
                <div className="flex flex-col items-center space-y-4 p-6 bg-white dark:bg-dark rounded shadow dark:shadow-gray-300">
                  ...
                  <p className="text-cener text-gray-500">
                    To inspire and empower individuals to reach their full
                    potential through fitness, fostering a healthier and happier
                    community.
                  </p>
                </div>
              </div>
              <div>
                <div className="flex flex-col items-center space-y-4 p-6 bg-white dark:bg-dark rounded shadow dark:shadow-gray-300">
                  ...
                  <p className="text-cener text-gray-500">
                    We pride ourselves on creating a welcoming, inclusive
                    environment where members support and motivate each other to
                    achieve their goals.
                  </p>
                </div>
              </div>
              <div>
                <div className="flex flex-col items-center space-y-4 p-6 bg-white dark:bg-dark rounded shadow dark:shadow-gray-300">
                  ...
                  <p className="text-cener text-gray-500">
                    We combine cutting-edge equipment, personalized training
                    programs, and nutritional guidance to help you achieve
                    sustainable results.
                  </p>
                </div>
              </div>
