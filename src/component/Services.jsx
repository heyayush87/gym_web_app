  ...
  const servicesJson = [
    {
      ...
      description:
        "Build muscle and increase your strength with our expert-led weight training programs.",
      icon: Dumbbell,
    },
    {
      title: "Group Classes",
    ...
    },
    {
      ...
      description:
        "Improve your cardiovascular health with our state-of-the-art cardio equipment and classes.",
      icon: Heart,
    },
    {
      title: "Spin Classes",
      description:
        "Pedal your way to fitness with our high-intensity spin classes led by certified instructors.",
      icon: Bike,
    },
  ];
  return (
      ...
      <div className="bg-white/10 dark:bg-black/60 px-6 md:px-0">
        <div className="max-w-7xl mx-auto min-h-[620px] flex items-center">
          <div className="md:w-1/2 w-full mx-auto space-y-5">
            <h1 className="text-red-500 font-bold text-4xl text-center mb-12">
              Our Services
            </h1>
