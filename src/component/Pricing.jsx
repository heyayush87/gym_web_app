...
const Pricing = () => {
  ...
  return (
    <section
      id="pricing"
      className="p-8 pb-20 pt-10 text-center bg-slate-50 dark:bg-dark dark:text-white"
    >
          ...
          {pricingJson.map((item, index) => {
            return (
              ...
              >
                ...
                <button className="bg-dark dark:bg-white dark:text-black text-white px-3 py-2 rounded-md w-full mt-4">
                  Choose Plan
                </button>
              </div>
            );
